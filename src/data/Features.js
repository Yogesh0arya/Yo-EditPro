const Features = [
  {
    ...
    desc: "Merge Videos Effortlessly",
    content:
      "Combine multiple video files seamlessly and export your final cut with ease.",
    isPresent: true,
  },
  {
    path: (
    ...
    desc: "Dynamic Image Overlays",
    content:
      "Layer multiple images with custom positioning, sizing, timing, and opacity.",
    isPresent: true,
  },
  {
    path: (
    ...
    desc: "Multiple Subtitle Tracks",
    content:
      "Add and manage multiple subtitle tracks, just like adding images.",
    isPresent: true,
  },
  {
    path: (
    ...
    content:
      "Enhance your videos mood by adding background music effortlessly.",
    isPresent: true,
  },
  {
    path: (
    ...
    content:
      "Our intelligent algorithms help you create perfect cuts, transitions, and effects automatically.",
    isPresent: false,
  },
  {
    path: (
    ...
    desc: "Templates & Effects",
    content:
      "Choose from hundreds of professionally designed templates and effects to enhance your videos.",
    isPresent: false,
  },
  {
    path: (
    ...
    desc: "Cloud Storage",
    content:
      "Access your projects from anywhere with unlimited cloud storage for all your video assets.",
    isPresent: false,
  },
  {
    path: (
    ...
    content:
      "Work with your team in real-time with seamless collaboration features built for creators.",
    isPresent: false,
  },
  {
    path: (
    ...
    desc: "Music & Sound Library",
    content:
      "Access thousands of royalty-free music tracks and sound effects to enhance your videos.",
    isPresent: false,
  },
  {
    path: (
    ...
    desc: "4K Export",
    content:
      "Export your videos in ultra-high definition 4K quality with advanced encoding options.",
    isPresent: false,
  },
];
